<!-- BEGIN: GUARDRAILS_KIT (managed by propagate-guardrails-kit.sh – do not edit between markers) -->
## Guardrails Kit v1.0 – Fable-parity procedures for Opus / Sonnet

<!-- Source: github.com/TheColliny/FableClaudeMDForOpus (v1.0), vendored into cc-setup; U+2014 converted to U+2013 per house style. On-demand playbooks live in docs/guardrails/*.md. -->
These guardrails AUGMENT AGENTS.md; they do not replace it. Precedence where they meet: a Hard-stop "wait for approval" before an irreversible action (weakening a check, git push, deleting files) is a safety confirmation and takes priority over AGENTS.md Rule 3 "never ask" – Rule 3 bans clarifying questions, not safety stops. All other AGENTS.md rules stand as written.
